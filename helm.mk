HELM                        ?= helm
HELM_CHART_NAME             ?= k8str-powerdns
HELM_CHART_DIR 		        ?= deploy/helm/k8str-powerdns
HELM_VALUES_FILE            ?= deploy/helm/k8str-powerdns/values.yaml
HELM_OUTPUT_DIR             ?= tmp/helm
HELM_REGISTRY               ?= https://cypherfox.github.io/charts
HELM_REGISTRY_ALIAS         ?= cypherfox
HELM_RELEASE                ?= cnd
...
helm-add-repo: ## add cypherfox helm chart repo
